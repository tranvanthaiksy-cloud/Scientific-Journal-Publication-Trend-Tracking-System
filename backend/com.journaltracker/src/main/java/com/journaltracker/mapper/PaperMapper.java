...
public interface PaperMapper {
    ...
    default PaperDetailResponse.JournalDetail mapJournalDetail(
        ...
        PaperDetailResponse.JournalDetail detail =
                new PaperDetailResponse.JournalDetail();
    ...
    default List<PaperDetailResponse.AuthorDetail> mapAuthorDetails(
        ...
        return authors.stream()
                .map(author -> {
                    PaperDetailResponse.AuthorDetail detail =
                            new PaperDetailResponse.AuthorDetail();
    ...
    default List<PaperDetailResponse.KeywordDetail> mapKeywordDetails(
        ...
        return keywords.stream()
                .map(keyword -> {
                    PaperDetailResponse.KeywordDetail detail =
                            new PaperDetailResponse.KeywordDetail();
